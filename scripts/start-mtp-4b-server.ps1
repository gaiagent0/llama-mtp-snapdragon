# start-mtp-4b-server.ps1
# Qwen3.5-4B-MTP szerver indítása Snapdragon X Elite-en
# Port: 8082 | Flash-Attn: igen | KV cache: q4_0 (memóriakímélő)
# Megjegyzés: elfér a 35B-A3B MELLETT egyidejűleg (~23.5 GB össz)

param(
    [string]$ModelPath = "E:\models\mtp-small\Qwen3.5-4B-MTP-UD-Q4_K_XL.gguf",
    [int]$Port = 8082,
...
Write-Host "  Qwen3.5 MTP 4B - Snapdragon szerver" -ForegroundColor Cyan
