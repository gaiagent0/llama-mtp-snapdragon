# MTP llama-server -- Qwen3.5-4B -- Snapdragon X Elite ARM64

$server = "C:\Users\istva\SnapdragonNPU_Build\install-mtp\llama-server.exe"
$model  = "E:\models\mtp-models\mtp-small\Qwen3.5-4B-UD-Q4_K_XL.gguf"
...
Write-Host "MTP szerver inditasa (4B)..." -ForegroundColor Cyan
