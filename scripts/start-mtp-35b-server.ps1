# MTP llama-server -- Qwen3.6-35B-A3B -- Snapdragon X Elite ARM64

$server = "C:\Users\istva\SnapdragonNPU_Build\install-mtp\llama-server.exe"
$model  = "E:\models\mtp-models\mtp\Qwen3.6-35B-A3B-UD-Q4_K_XL.gguf"
...
Write-Host "MTP szerver inditasa (35B)..." -ForegroundColor Cyan
